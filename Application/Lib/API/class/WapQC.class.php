 ...
 */
require_once(CLASS_PATH."WapOauth.class.php");
    ...
    public function __construct($access_token = "", $openid = ""){
        ...
        $this->APIMap = array(
            ...
            "get_user_info" => array(
                ...
                array("access_token"=>$this->keysArr['access_token'],"openid"=>$this->keysArr['openid'],"oauth_consumer_key"=>$this->keysArr['oauth_consumer_key'],"format" => "json"),
                "GET"
            ),
            "add_one_blog" => array(
                "https://graph.qq.com/blog/add_one_blog",
            ...
            "add_share" => array(
                ...
                array("title"=>"QQ空间", "url"=>"http://www.qzone.com/", "comment"=>"测试","summary"=>"灵接触网","#images","format" => "json","#type","#playurl","#nswb","site"=>"灵机妙算","fromurl"=>"http://s.ggwan.com"),
                "POST"
            ),
