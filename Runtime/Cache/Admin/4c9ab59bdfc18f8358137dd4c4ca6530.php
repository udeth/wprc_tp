...
<head>
	...
	<script src="/Public/static/jquery.MultiFile.js" type="text/javascript"></script>
...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal" enctype="multipart/form-data">
			<?php if(!empty($goods)): ?><label class="item-label">ID</label>
            <input type="text" class="text input-large" name="id" value=""><?php endif; ?>
        <div class="form-item">
            <label class="item-label">商品名称</label>
            <div class="controls">
                <input type="text" class="text input-large" name="shop_name" value="">
            </div>
        </div>
		<div class="form-item">
            <label class="item-label">所需积分</label>
            <div class="controls">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="market_price" value="">
            </div>
        </div>
		<div class="form-item">
            <label class="item-label">所属专区</label>
            <div class="controls">
                <select name="zhuanqu_id">
                    <?php if(is_array($zhuanqu)): $i = 0; $__LIST__ = $zhuanqu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["zhuanqu_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
		<div class="form-item">
