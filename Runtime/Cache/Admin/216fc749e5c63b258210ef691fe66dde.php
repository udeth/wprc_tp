...
<body>
	...
	<div class="form-item">
		<table id="detail" class="">
			...
			<tr>
				<th>父评论用户</th>
				<td><?php echo ($data["puser_name"]); ?></td>
				<th>父评论时间</th>
				<td><?php echo ($data["ptime"]); ?></td>
			</tr>
			<tr>
				<th>父评论内容</th>
				<td colspan="3"><?php echo ($data["pcontent"]); ?></td>
			</tr>
			<tr>
				<th>网评用户</th>
				<td><?php echo ($data["ruser_name"]); ?></td>
				<th>网评时间</th>
				<td><?php echo ($data["rtime"]); ?></td>
			</tr>
			<tr>
				<th>网评内容</th>
				<td colspan="3"><?php echo ($data["rcontent"]); ?></td>
			</tr>
		</table>
		</div>
        <div class="form-item">
    ...
    <script type="text/javascript">
        highlight_subnav('<?php echo U('Reply/index');?>');	// 导航高亮
    </script>
