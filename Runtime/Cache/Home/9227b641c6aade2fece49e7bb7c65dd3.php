...
<body>
	...
	<!-- <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>-->
		<img src="<?php if($userInfo[0]['image']){echo '/Uploads/Picture/User/'.$userInfo[0]['image'];}else{echo '/Public/static/img/default_big.jpg';} ?>" style="height:50px;display:block;float:left;margin-bottom:3px;vertical-align: middle;">
		<p style="float:left;height:50px;line-height:25px;padding-left:10px;">
			<span style="color:red;"><?php echo ($userInfo["0"]["name"]); ?></span><br>
			<span style="color:#898788;font-size:12px;"><?php echo (date("Y-m-d",$list["time"])); ?></span>	
		</p>
		<p style="clear:both"></p>
		<a href="/home/act/reviewInfo?id=<?php echo ($list["id"]); ?>"><div style="border:solid 1px #D4D0D1;padding:0 10px;margin-top:5px;margin-bottom:20px">
			<p style="text-align:left;background:#FEE6DA;margin:10px auto;WORD-WRAP: break-word;TABLE-LAYOUT: fixed;word-break:break-all">
			...
			<div style="color:#888785;height:30px;line-height:30px;font-size:12px;">
				<img src="/Public/static/img/pinglun.jpg" style="vertical-align: middle;">&nbsp;评论(<?php echo ($list["comment_count"]); ?>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
				<img src="/Public/static/img/xingxing.jpg" style="vertical-align: middle;">&nbsp;收藏(<?php echo ($list["collect_count"]); ?>)
			</div>
		</div></a>
