...
<div class="system-message">
    ...
    <div style="margin-top:80px;">
        ...
        <p class="jump" style="text-align:center;width:250px;margin:20px auto;height:30px;color:black;">
            页面<b id="wait"><?php echo($waitSecond); ?></b> 秒后页面将自动跳转,如不能跳转请点击&nbsp;&nbsp;<a id="href" id="btn-now" href="<?php echo($jumpUrl); ?>">这里</a>...
        </p>
        <div style="width:550px;margin:40px auto;diaplay:table">
            <div style="display:table-cell;width:200px;vertical-align: bottom;float:left">
                <img src="/Public/static/img/success.jpg" style="margin:auto auto;width:100px;;display:block">
            </div>
            <div style="display:table-cell;width:300px;margin-left:4%;vertical-align: bottom;float:left;color:black">
                <?php echo($message); ?>
            </div>
